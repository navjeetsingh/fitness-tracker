...
// Strava does have real activity tags (confirmed against a live account — e.g. a walk
// tagged "WithPet"), but that field isn't exposed through the public OAuth API this
// app authenticates with, only Strava's own internal clients. This is a best-effort
// stand-in: scan the free-text activity description for #hashtag-style tokens
// (e.g. "#WithPet") instead.
...
// Full DetailedActivity for the activity-detail view (the dashboard list only has
// SummaryActivity, which lacks description/full photos/route polyline).
